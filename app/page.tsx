...
import { Spotlights } from "@/components/pages/spotlight";
import Image from "next/image";
import React from "react";

export default function homepage() {
  return (
    <main className="bg-[#eed9c4]">
      <Top/>
      <div>
        <Spotlights />
      </div>
      <div>
        <section className="flex w-full bg-[#d9b99b]">
                  ...
                  <li>
                    <a href="#" className="group block">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="mt-1 text-base text-gray-700">$150</p>
                      </div>
                    </a>
                  </li>
