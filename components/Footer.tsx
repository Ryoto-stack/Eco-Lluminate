    ...
    <footer className="bg-[#f1c49a]">
        <div className="mx-auto max-w-5xl px-4 py-5 sm:px-6 lg:px-8">
          ...
          <ul className="mt-5 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
            <li>
              <a
                className="text-[#8b6643] font-bold transition hover:text-[#ddae81]"
                href="#"
              >
                {" "}
                Collection{" "}
          ...
          <ul className="mt-5 flex justify-center gap-6 md:gap-8">
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=61560535689947"
                rel="noreferrer"
                target="_blank"
                className="text-[#8b6643] transition hover:text-[#ddae81]"
              >
            ...
            <li>
              <a
                href="https://www.instagram.com/scentedcraft.inc/"
                rel="noreferrer"
                target="_blank"
                className="text-[#8b6643] transition hover:text-[#ddae81]"
              >
